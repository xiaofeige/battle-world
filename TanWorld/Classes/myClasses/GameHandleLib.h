...
*PARA:	Node*	_root:	search root of the csb file
		string&	name:	name of node,when you edit in cocostuio,you gave it a name
*DESC:	select the very widget from csb file by name. In this way,you will no longer
		be trouble to find the widget from csb file;
**/
